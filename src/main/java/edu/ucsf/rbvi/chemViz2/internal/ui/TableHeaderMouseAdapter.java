...
class TableHeaderMouseAdapter extends MouseAdapter implements ActionListener {
	private	TableRowSorter sorter;
	private JTable table;
	private ChemInfoTableModel tableModel;
	private CyNetwork network;

	TableHeaderMouseAdapter(JTable table, ChemInfoTableModel tableModel, TableRowSorter sorter) {
		this.table = table;
		this.sorter = sorter;
